...
import Cherries from '../img/uwcherries.jpg';
            ...
            <div>
                <MediaQuery minDeviceWidth={1024}>
                    <div style={{display: "flex", flexDirection: "row"}}>
                        ...
                        <div style={{display: "flex", width: "40%", flexDirection: "column", background: "#393e46", color: "white"}}>
                            <img src={Cherries} alt="cherry trees at University of Washington"></img>
                        </div>
                    </div>
                </MediaQuery>
